...
#define 	 STM32_EXT_SRAM_SIZE		(STM32_EXT_SRAM_END - STM32_EXT_SRAM_BEGIN)
void checksram(int tsize)
{
...
FINSH_FUNCTION_EXPORT(checksram,check sram.)
#endif
#endif
